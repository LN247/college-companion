        ...
        <div className='welcome-box'>
          <h1>Join us </h1>
            ...
            <form onSubmit={handleSubmit}>
             <div className='login-message'> <h2>signup</h2></div>
           ...
           <label htmlFor='name' className='label'>Full Name</label>
            <input type='text' placeholder='Name' name='name' className='input' autoComplete='name' value={fullname} onChange={(e)=> setFullname(e.target.value)} />
           ...
           <label htmlFor='email' className='label'>Email</label>
            <input type='email' placeholder='Email' name='email' className='input' autoComplete='email' value={email} onChange={(e)=> setEmail(e.target.value) } />
           
            </div>
   
            <div className='input-box'>
            <label htmlFor="password" className='label'>password</label>
            <input type='password' placeholder='Password' name='password' className='input' autoComplete='new-password' value={password} onChange={(e)=> setPassword(e.target.value)}/>
            </div>
            <div className='remember-me'>
          <input type='checkbox' name='remember' className='checkbox' checked={agree} onChange={(e) => setAgree(e.target.checked)} />
          ...
          <button className='google-button'  onClick={()=>googleSignup()}><img src={GoogleIcon} className='google-icon'/>continue with Google</button>
            <div>
